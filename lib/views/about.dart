      ...
      ListTile(
        title: Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            globalState.packageInfo.version.contains('mod')
                                ? globalState.packageInfo.version.replaceAll('-', '_')
                                : '${globalState.packageInfo.version}_mod',
            ...
            Text(
              '• Поддержка импорта прямых ссылок и списков прокси (VLESS, VMess, Trojan, SS, Hysteria2, TUIC)\n'
              '• Автоматическое определение названия подписки из заголовков и содержимого\n'
              '• Прямой TCP Handshake замер задержки серверов для работы с узлами из белого списка\n'
              '• Встроенные оптимизированные DNS конфигурации для стабильного подключения',
